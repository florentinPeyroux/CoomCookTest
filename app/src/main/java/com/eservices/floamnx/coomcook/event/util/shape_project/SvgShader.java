...
public class SvgShader extends ShaderHelper {
    private static final int BORDER_TYPE_DEFAULT = 0;
    private static final int BORDER_TYPE_FILL = 1;

    private static final int STROKE_CAP_DEFAULT = -1;
    private static final int STROKE_CAP_BUTT = 0;
    private static final int STROKE_CAP_ROUND = 1;
    private static final int STROKE_CAP_SQUARE = 2;

    private static final int STROKE_JOIN_DEFAULT = -1;
    private static final int STROKE_JOIN_BEVEL = 0;
    private static final int STROKE_JOIN_MITER = 1;
    private static final int STROKE_JOIN_ROUND= 2;
    ...
    private void setStrokeMiter(int strokeMiter) {
    ...
    private void setStrokeCap(int strokeCap) {
    ...
    private void setBorderType(int borderType) {
    ...
    public void calculate(int bitmapWidth, int bitmapHeight, float width, float height, float scale, float translateX, float translateY) {
        ...
        float scale1 = Math.min(width / pathDimensions[0], height / pathDimensions[1]);
        float translateX1 = Math.round((width - pathDimensions[0] * scale1) * 0.5f);
        float translateY1 = Math.round((height- pathDimensions[1] * scale1) * 0.5f);
        pathMatrix.setScale(scale, scale);
        pathMatrix.postTranslate(translateX1, translateY1);
