...
public class CompleteSignUpGoogle extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePickerDialog = new DatePickerDialog(this, CompleteSignUpGoogle.this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
    ...
    private void addUser() {
        ...
        String age = String.valueOf(actualYear - Integer.parseInt(birthYear) );
        ...
        if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(surname) && !TextUtils.isEmpty(city) && birthYear!=null) {
            ...
            startActivity(new Intent(CompleteSignUpGoogle.this, DidacticielActivity.class));
        } else {
    ...
    public void getUserBasicData() {
        imageUrl = firebaseAuth.getCurrentUser().getPhotoUrl().toString();
        if (firebaseAuth.getCurrentUser().getPhotoUrl().toString() != null) {
            ImageUtil.displayRoundImage(imageView, firebaseAuth.getCurrentUser().getPhotoUrl().toString(), null);
        }
        editTextName.setText((firebaseAuth.getCurrentUser().getDisplayName()));
    }
