...
public class MaterialRippleLayout extends FrameLayout {
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        SimpleOnGestureListener longClickListener = new GestureDetector.SimpleOnGestureListener() {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        PerformClickEvent pendingClickEvent;
    ...
    private void startHover() {
        ...
        final float mradius = (float) (Math.sqrt(Math.pow(getWidth(), 2) + Math.pow(getHeight(), 2)) * 1.2f);
        hoverAnimator = ObjectAnimator.ofFloat(this, radiusProperty, rippleDiameter, mradius)
    ...
    private void startRipple(final Runnable animationEndRunnable) {
        ...
        fade.setStartDelay(rippleDuration - rippleFadeDuration - (long)FADE_EXTRA_DELAY);
